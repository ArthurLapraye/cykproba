...
\begin{frame}
 \frametitle{CYK}
 \begin{itemize}
  \item<1-5> Binarisation 
  \item<2-5> minimiser la grammaire 
  \item<3-5> Intégrer les probas dans CYK
 \item<4-5> les traits morphosyntaxiques ( FCFG, NT en plus ? )
  \item<5> gestion des mots inconnus (lemmatisation, lissage...)
