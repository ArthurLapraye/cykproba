...
\begin{itemize}
 \item{Un algorithme gourmand en temps et en mémoire}
 \item{Optimiser la recherche de récritures possibles}
...
\begin{itemize}
 \item {Une évaluation problématique.}
 \item {La mesure dite de PARSEVAL}
 \item {Précision, Rappel et f-mesure}
\end{itemize}
