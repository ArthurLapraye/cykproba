...
class CKY_TITOV(object):
    def __init__(self):
        self.chart = collections.defaultdict(lambda : collections.defaultdict(int))
    ...
    def predit(self, phrase, cnf):
        print('Prédiction: ')

        chart = collections.defaultdict(lambda : collections.defaultdict(int))

        return self.get_sommet(self.remplit(phrase, cnf, self.initialise(phrase, cnf)), phrase)
        # return get_arbre(get_sommet(remplit(phrase, cnf, initialise(phrase, cnf, chart))))

    def get_sommet(self, chart, phrase):
    ...
    def initialise(self, phrase, cnf):
    ...
    def remplit(self, phrase, cnf, chart):
